    ...
    <?php $init->getHeader() ?>
         ...
         <div class="row">
           <div class="col-sm-1"></div>
             <div class="col-sm-10">
               ...
               <h4 class="text-center">Part-Time Directory</h4>
               <br>
               <div class="box box-default">
                 <div class="box-header with-border">
                   <button data-target="#newFaculty" type="button" class="btn btn-primary" data-toggle="modal">New Part-Time</button>
                 </div>
                   <div class="box-body">
                     <?php
                       ...
                       $t .= '<th width="15%">Department</th>';
                       $t .= '<th width="40%">Position</th>';
                       $t .= '<th width="15%" class="text-center">Action</th>';
                       $t .= '</tr>';
                       $t .= '</thead>';
                       $t .= '<tbody>';
                       $f = $faculty->iShowFaculty("Part-Time");
     ...
     <div class="modal fade" id="newFaculty">
       <div class="modal-dialog">
         <div class="modal-content">
           <div class="modal-header">
             <h3 class="text-center">Add Part-Time</h3>
             <center><a href="#" data-dismiss="modal"><i class="fa fa-times-circle fa-2x"></i></a></center>
           </div>
           <div class="modal-body">
     ...
     <div class="modal fade" id="editFaculty">
       <div class="modal-dialog">
         <div class="modal-content">
           <div class="modal-header">
             <h3 class="text-center">Edit Part-Time</h3>
             <center><a href="#" data-dismiss="modal"><i class="fa fa-times-circle fa-2x"></i></a></center>
           </div>
           <div class="modal-body">
             <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post" enctype="multipart/form-data">
               <div class="row">
                 <div class="col-sm-4">
                   ...
                   <div class="form-group hide">
                     ...
                     <input type="hidden" class="form-control" name="editCat" id="editCat" value="Part-Time">
                   </div>
                   <div class="form-group">
