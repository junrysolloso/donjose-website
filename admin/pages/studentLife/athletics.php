   ...
   <body>
     ...
     <div class="container-fluid">
       <div class="container">
         ...
         <h4 class="text-center">Athletics</h4>
         <br>
         <div class="row">
           <div class="col-sm-1"></div>
            <div class="col-sm-10">
              ...
              <?php
                 $org = new process();
                 $t  = '<table id="athleticsTable">';
                 $t .= '<thead><tr><th></th></tr></thead>';
                 $t .= '<tbody>';
                 $f = $org->iGetStudentActivity("Athletics");
               ...
               <div class="row">
                 ...
                 <div class="col-sm-8">
                   ...
                   <div class="form-group hide">
                     ...
                     <input type="hidden" class="form-control" name="orgCat" id="orgCat" value="Athletics">
                   </div>
                   <div class="form-group">
