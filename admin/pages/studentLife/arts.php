   ...
   <body>
     ...
     <div class="container-fluid">
       <div class="container">
         ...
         <h4 class="text-center">Arts And Culture</h4>
         <br>
         <div class="row">
           <div class="col-sm-1"></div>
            <div class="col-sm-10">
              ...
              <?php
                 $org = new process();
                 $t  = '<table id="artsTable">';
                 $t .= '<thead><tr><th></th></tr></thead>';
                 $t .= '<tbody>';
                 $f = $org->iGetStudentActivity("Arts");
               ...
               <div class="row">
                 ...
                 <div class="col-sm-8">
                   ...
                   <div class="form-group hide">
                     ...
                     <input type="hidden" class="form-control" name="orgCat" id="orgCat" value="Arts">
                   </div>
                   <div class="form-group">
           ...
           <div class="modal-body">
             <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post" enctype="multipart/form-data">
               <div class="row">
                 ...
                 <div class="col-sm-6">
                   <div class="form-group hide">
                     <label for="editId">Event Id</label>
     ...
     <script>
      $(function () {
        $(window).load(function () {
          ...
          $(".subBtnStudentLife").eq(0).addClass("subBtn");
